...
The current Windows build is available from the [6.2.3 nightly artifact](https://nightly.link/nuttyinc578/the-cube/workflows/build-6.2.3/main/The-Cube-Beta-6.2.3-Windows.zip).
